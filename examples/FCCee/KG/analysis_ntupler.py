...
outputDir   = "outputs/FCCee/Zqq/asymmetries"
    ...
    def analysers(df):
        df2 = (df
	       ...
	       # finding SVs in jets 
               ...
               .Define("Z_flavour",     "JetTaggingUtils::get_Z_flavour(jets_ee_kt, Particle)") # default signed flavour to be used (q-qbar separated)
               ...
               .Define("RPj_charged_isKaon", "ReconstructedParticle::sel_template(true)(RPj_hasTRK, RPj_is_Kaon)")
