...
int main()
{
  TFile *hists23=TFile::Open("histZuds_gm_auto.root");
  TFile *hists7x=TFile::Open("histZuds_gm7x_auto.root");
  ...
  jetFlavour7x->Draw();
  //
  c1->Print("GM_comparison_auto.pdf");  
  /*
  ...
  //
  c2->Print("GM_comparison2_auto.pdf");  
  */
  hists23->Close();
  hists7x->Close();
